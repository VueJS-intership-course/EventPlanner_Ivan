        ...
        <div class="d-flex flex-column p-2 main-container my-4">
          <form @submit.prevent="onSubmit">
            ...
            <div class="input-wrapper">
              ...
              <input :value="dateAndTime.date" class="form-control" type="date" id="date" />
            </div>
            <div class="input-wrapper">
              <label class="form-label mt-4">Time</label>
              <input :value="dateAndTime.time" class="form-control" type="time" id="time" />
